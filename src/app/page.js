    ...
    <>
      ...
      <ThemeProvider theme={theme}>
        <main className={styles.main}>
              ...
              <div>
                <Box sx={{margin: '0.75rem', textAlign: 'center'}}>
                  <a href='/documents/WG_CV.pdf'>
                    <Button color='info' variant='contained' sx={{fontFamily:'Poppins'}}><Download/> Curriculum Vitae</Button>
                  </a>
                </Box>
                <Box>
                ...
                <Box width={'90vw'} margin='0 auto' className={styles.skillBank}>
            ...
            <Box width={'90vw'} margin='0 auto' mt='2rem' mb='3rem' className={styles.actionBank} id='achievements'>
              ...
              <Box component='div' sx={{mt: '1rem', justifyContent: 'center'}}>
                <Grid container spacing={1}>
                  <Grid className={styles.actionImages} item xs={0} sm={7}>
          ...
          <StyledDivider/>
          <Box width={'90vw'} margin='0 auto' mt='2rem' mb='3rem' id='aspirations'>
            <Grid container spacing={'1rem'}>
              <Grid item xs={12} sm={6} mb='2rem'>
                        ...
                        <Grid item xs={12} sm={6}>
                          <Paper elevation={2} sx={{bgcolor: '#252525'}}>
                            <Box margin='1rem'>
                              ...
                              <Typography fontFamily={'Poppins'} pb='1rem' color='text.secondary'>{bio}</Typography> 
                            </Box>
                          </Paper>
                        </Grid>
                      </Grid>
                  ...
                  <FadeInSection>
                    <TableContainer>
                      <Table stickyHeader>
                        <TableHead>
                          <TableRow>
                            {["ID", "Course", "Grade"].map((header) => (<TableCell key={header.toLowerCase()} align='center'>
                          ...
                          {relevantCourses.slice(page * 5, page * 5 + 5).map((course) => course in courseInfo ? (
                            <React.Fragment key={course}>
                              <TableRow hover>
                                ...
                                <TableCell>
                                  <Typography color='text.secondary' fontFamily='Poppins'>{courseInfo[course][1]}</Typography>
                                </TableCell>
                              </TableRow>
                              <TableRow>
              ...
              <Grid item xs={12} sm={5}>
                <FadeInSection>
                  <Grid id='projects' container spacing={1}>
